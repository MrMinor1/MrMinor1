...
OUT = "/home/user/MrMinor1/content/2026-07-30/slides-bosstaxpro"
...
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  <span class="kicker">The Quiet Window</span>
  <div class="h1 chrome" style="margin-top:30px">Two deadlines<br>land tomorrow.</div>
  <div class="h1 gold" style="margin-top:12px">Then nothing<br>for six weeks.</div>
  <div class="rule"></div>
  <div class="sub" style="max-width:850px">That gap is the most valuable real estate on your tax calendar &mdash; and almost nobody uses it.</div>
  <div style="margin-top:44px"><span class="pill">SWIPE &rarr;</span></div>
</div>""",1)

S["02-deadlines"]=page("""
<span class="kicker">Tomorrow &mdash; Friday, July 31</span>
<div class="h2" style="margin-top:24px">Two filings, <span class="gold">one day.</span></div>
<div class="row" style="margin-top:42px">
  <div class="card"><div class="lbl gold">Form 941</div>
    <div class="val chrome">Q2 payroll<br>return</div>
    <div class="note">Your employer&rsquo;s quarterly federal tax return.</div></div>
  <div class="card"><div class="lbl gold">Form 5500</div>
    <div class="val chrome">CY2025<br>benefit plans</div>
    <div class="note">5500 or 5500-EZ. Solo 401(k) owners &mdash; this one catches people.</div></div>
</div>""",2)

S["03-finePrint"]=page("""
<span class="kicker">The fine print nobody reads</span>
<div style="display:flex;align-items:center;gap:32px;margin-top:30px">
  <div class="badge">+10</div>
  <div class="h2" style="flex:1">941 filers get<br><span class="gold">10 extra days.</span></div>
</div>
<div class="card" style="margin-top:40px">
  <div class="lbl gold">If every Q2 deposit was on time</div>
  <div class="val gold" style="font-size:66px">Deadline &rarr; August 10</div>
  <div class="note">Miss a single deposit and it doesn&rsquo;t apply. The extension rewards the depositing, not the filing.</div>
</div>""",3)

S["04-gap"]=page("""
<span class="kicker">Then the calendar empties</span>
<div class="h2" style="margin-top:22px">Six weeks of <span class="gold">open road.</span></div>
<div class="tl"><div class="fill"></div>
  <div class="dot" style="left:calc(16% - 22px)"></div>
  <div class="dotO" style="left:calc(100% - 22px)"></div>
  <div class="tlab" style="left:16%">JUL 31<br><span style="font-weight:400;font-size:23px;opacity:.7">941 + 5500</span></div>
  <div class="tlab" style="left:100%">SEP 15<br><span style="font-weight:400;font-size:23px;opacity:.7">Q3 estimates</span></div>
</div>
<div class="sub" style="margin-top:148px">Nothing else is due in between. It is the only stretch of the year when a tax decision isn&rsquo;t made under a deadline.</div>""",4)

S["05-why"]=page("""
<span class="kicker">Why timing decides the value</span>
<div class="h2" style="margin-top:22px">Same move.<br><span class="gold">Different runway.</span></div>
<div class="vs" style="margin-top:40px">
  <div class="a"><div class="t gold">August</div><div class="n gold">5</div>
    <div class="d">months for the change to compound</div></div>
  <div class="b"><div class="t" style="color:rgba(233,238,244,.6)">December</div>
    <div class="n chrome">3</div><div class="d">weeks &mdash; most levers already closed</div></div>
</div>
<div class="sub" style="margin-top:36px;font-size:32px">S-Corp elections, reasonable comp, retirement funding, equipment timing. Every one needs runway.</div>""",5)

S["06-quote"]=page("""
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  <div style="font-size:150px;line-height:.55;font-weight:800">&ldquo;</div>
  <div class="h1" style="font-size:78px;margin-top:22px">Nobody is too<br>busy in August.</div>
  <div class="h1" style="font-size:78px;margin-top:14px;opacity:.55">They&rsquo;re too busy<br>in December.</div>
  <div style="margin-top:48px;font-size:28px;font-weight:800;letter-spacing:6px">&mdash; BOSS TAX PRO</div>
</div>""",6,inv=True)

S["07-cta"]=page("""
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  <span class="kicker">Free 30-Minute Review</span>
  <div class="h1 gold" style="margin-top:26px">Use the quiet<br>while you have it.</div>
  <div class="rule"></div>
  <div class="sub">Your numbers, your entity, your payroll &mdash; then a one-page plan you can run yourself. No pitch.</div>
  <div style="margin-top:44px"><span class="pill">HELPMYBIZZ.COM</span></div>
</div>""",7)
