...
OUT = "/home/user/MrMinor1/content/2026-08-01/slides-bosstaxpro"
...
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  <span class="kicker">Payroll Software &middot; Honest Take</span>
  <div class="h1 chrome" style="margin-top:26px">The cheapest payroll<br>on your list</div>
  <div class="h1 gold" style="margin-top:12px">probably doesn&rsquo;t file<br>your taxes.</div>
  <div class="rule"></div>
  <div class="sub" style="max-width:860px">You just lived through a 941 deadline. Here&rsquo;s what the price tags actually buy.</div>
  <div style="margin-top:40px"><span class="pill">COMPARE &rarr;</span></div>
</div>""",1)

S["02-prices"]=page("""
<span class="kicker">Published list pricing &middot; Aug 2026</span>
<div class="h2" style="margin-top:22px">Three common <span class="gold">options.</span></div>
<div class="row" style="margin-top:36px">
  <div class="card"><div class="lbl gold">Patriot</div>
    <div class="val chrome" style="font-size:38px">$17&ndash;$37<br><span style="font-size:26px">+ $4/employee</span></div>
    <div class="note">Basic vs Full Service. The gap between them matters more than the price.</div></div>
  <div class="card"><div class="lbl gold">QuickBooks</div>
    <div class="val chrome" style="font-size:38px">$45<br><span style="font-size:26px">+ $5/employee</span></div>
    <div class="note">Strongest if your books already live in QBO.</div></div>
  <div class="card"><div class="lbl gold">Gusto</div>
    <div class="val chrome" style="font-size:38px">$49<br><span style="font-size:26px">+ $6/employee</span></div>
    <div class="note">Most included out of the box &mdash; benefits, onboarding, compliance.</div></div>
</div>""",2)

S["03-line"]=page("""
<span class="kicker">The line that actually matters</span>
<div class="h2" style="margin-top:22px">Does it <span class="gold">file</span> &mdash;<br>or just calculate?</div>
<div class="card" style="margin-top:36px">
  <div class="note" style="font-size:33px;margin-top:0">Patriot&rsquo;s <b>Basic</b> tier runs payroll. <b class="gold">You</b> still file the 941, the state returns and the W-2s. Full Service is the tier that files for you.</div>
</div>
<div class="sub" style="margin-top:30px;font-size:33px">A $20/month saving that hands you a filing calendar isn&rsquo;t a saving. It&rsquo;s a job.</div>""",3)

S["04-math"]=page("""
<span class="kicker">Five employees, real numbers</span>
<div class="h2" style="margin-top:22px">What you&rsquo;d <span class="gold">actually pay.</span></div>
<div class="sub" style="margin-top:34px;font-size:38px">
Patriot Basic &nbsp;&nbsp;<b class="gold">$37/mo</b> &nbsp;&mdash; you file<br><br>
Patriot Full &nbsp;&nbsp;&nbsp;&nbsp;<b class="gold">$57/mo</b> &nbsp;&mdash; they file<br><br>
QuickBooks &nbsp;&nbsp;&nbsp;&nbsp;<b class="gold">$70/mo</b><br><br>
Gusto &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b class="gold">$79/mo</b></div>
<div class="sub" style="margin-top:30px;font-size:29px;opacity:.75">List pricing, no promos or add-ons. Verify before you buy.</div>""",4)

S["05-fit"]=page("""
<span class="kicker">Which one is actually yours</span>
<div class="h2" style="margin-top:22px">It depends on <span class="gold">one thing.</span></div>
<div class="sub" style="margin-top:32px;font-size:35px">
<b class="gold">Already on QuickBooks Online?</b> QuickBooks Payroll, almost always. The integration is worth more than the price gap.<br><br>
<b class="gold">Hiring, adding benefits, growing?</b> Gusto. You&rsquo;ll grow into what&rsquo;s included.<br><br>
<b class="gold">One or two employees, steady, and you&rsquo;ll genuinely do the filings?</b> Patriot Basic is honestly fine.</div>""",5)

S["06-quote"]=page("""
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  <div style="font-size:150px;line-height:.55;font-weight:800">&ldquo;</div>
  <div class="h1" style="font-size:74px;margin-top:20px">Payroll isn&rsquo;t priced<br>by features.</div>
  <div class="h1" style="font-size:74px;margin-top:14px;opacity:.55">It&rsquo;s priced by who<br>carries the penalty.</div>
...
<div style="flex:1;display:flex;flex-direction:column;justify-content:center">
  ...
  <div class="h1 gold" style="margin-top:24px">We don&rsquo;t sell<br>any of these.</div>
  <div class="rule"></div>
  <div class="sub">No affiliate links, no commissions. We&rsquo;ll look at your headcount, your books and your filing history, then tell you which one fits &mdash; even if it&rsquo;s the cheapest.</div>
